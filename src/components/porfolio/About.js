            ...
            <div className="col-12 py-4">
              <ul className="text-box">
                ...
                <li>
                  ...
                  <strong>
                    {" "}
                    React JS, JavaScript, Redux, Styled Component, Storybook, HTML5, CSS3, Bootstrap and Material UI.
                  </strong>
                </li>
                <li>
                  Expertise in <strong>debugging and troubleshooting</strong> existing code using Developer Tools.
                </li>
                <li>
                  Strong experience with <strong>Cross Browser Compatibility issues</strong> and
                  <strong> Optimization of webpage</strong> for fast loading, including CSS, JavaScript and
                  HTML and best practices of
                ...
                <li>
                  ...
                  <strong>
                    {" "}
                   React-Routing, State-management, Rest API, SEO using Meta tags, React bootstrap, Material-UI
                  </strong>
                  .
                </li>
                <li>
          ...
          <div className="row fuct-items">
            ...
            <div className="col-xl-3 col-md-3 col-sm-6 col-6 mb-4">
              <div className="fuct-item">
                ...
                <div className="name">Invision</div>
              </div>
            </div>
